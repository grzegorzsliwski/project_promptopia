  ...
  return (
    <section className="w-full max-w-full flex-start flex-col"> 
      ...
      <p className="desc text-left max-w-md">
        {type} and share amazing prompts with the world and let your imagination with any AI-powered platform 
      </p>
      <form onSubmit={handleSubmit} className="mt-10 w-full max-w-2x1 flex flex-col gap-7 glassmorphism">
        ...
        <label>
          ...
          <textarea value={post.tag} onChange={(e) => setPost({ ...post, tag: e.target.value})} 
          placeholder="#tag" required className="form_textarea">
          </textarea>
        </label>
        <div className="flex-end mx-3 mb-5 gap-4">
          ...
          className="px-5 py-1.5 text-sm text-sm bg-primary-orange rounded-full text-white">
